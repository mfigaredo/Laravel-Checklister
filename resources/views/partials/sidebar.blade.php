      ...
      @if (auth()->user()->is_admin)
          ...
          @foreach (\App\Models\ChecklistGroup::with('checklists')->get() as $group)
              <li class="c-sidebar-nav-item c-sidebar-nav-dropdown c-show">
                  <a href="{{ route('admin.checklist_groups.edit', $group->id) }}" class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle">
                  ...
                  <ul class="c-sidebar-nav-dropdown-items">
                      @foreach ($group->checklists as $checklist)
                          <li class="c-sidebar-nav-item">
                              <a href="{{ route('admin.checklist_groups.checklists.edit', [$group, $checklist] )}}" class="c-sidebar-nav-link">
                      ...
                      @endforeach
                      <li class="c-sidebar-nav-item">
                          <a href="{{ route('admin.checklist_groups.checklists.create', $group) }}" class="c-sidebar-nav-link">{{ __('New checklist') }}</a>
                      </li>
                  </ul>
              </li>
          @endforeach
